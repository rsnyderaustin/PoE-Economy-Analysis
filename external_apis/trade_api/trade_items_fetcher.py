...
from external_apis.official_api.official_enums import OfficialConfig
...
class TradeItemsFetcher:
    ...
    def _get_with_item_ids(cls, search_id, item_ids):
        ...
        for chunked_ids in chunked_list:
            ...
            logging.info(f"Waiting {TradeApiConfig.QUERY_WAIT_TIME.value} seconds to send another GET for items.")
            time.sleep(TradeApiConfig.QUERY_WAIT_TIME.value)
