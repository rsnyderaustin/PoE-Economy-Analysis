...
class ProgramManager:
    ...
    def __init__(self):
        ...
        global_atypes_manager = poecd_api.PoecdManager().create_global_atypes_manager()
        self.resource_resolver = data_handling.ResourceResolver(global_atypes_manager=global_atypes_manager)
