...
class ListedSince(Enum):
    UP_TO_1_HOUR = ('1hour', 60)
    UP_TO_3_HOURS = ('3hours', 180)
    UP_TO_12_HOURS = ('12hours', 720)
    UP_TO_1_DAY = ('1day', 1440)
    UP_TO_3_DAYS = ('3days', 4320)
    UP_TO_1_WEEK = ('1week', 10080)
    UP_TO_2_WEEKS = ('2weeks', 20160)
    UP_TO_1_MONTH = ('1month', 40320)
    UP_TO_2_MONTHS = ('2months', 80640)

    def __init__(self, trade_query_id: str, minutes_equivalent: int):
        self.trade_query_id = trade_query_id
        self.minutes_equivalent = minutes_equivalent
