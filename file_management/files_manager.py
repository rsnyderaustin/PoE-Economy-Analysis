...
class FilesManager:
    ...
    def __init__(self):
        self.file_paths = {
            FileKeys.ATYPE_MODS: Path.cwd() / 'file_management/files/atype_mods.json',
            FileKeys.ATYPE_ENCODES: Path.cwd() / 'file_management/files/atype_encode.json',
    ...
    def cache_encodings(self, listing: ModifiableListing) -> bool:
        """
